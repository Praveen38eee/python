...
Before generating a dictionary you need to check whether the entered age value is positive or not. If negative then we should add the details to the dictionary.​
